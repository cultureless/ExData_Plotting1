plot4 <- function() {
  ...
  ##Create two vectors of data for graphing the sub metering data. The first is all the sub metering data.
  ...
  ##Render 4 graphs as a png file
  png(file = "plot4.png")
  par(mfrow = c(2, 2))
  plot(timesct, days$Global_active_power, col = "black", type = "l", main = "", xlab = "", ylab = "Global Active Power")
  plot(timesct, days$Voltage, col = "black", type = "l", main = "", xlab = "datetime", ylab = "Voltage")
  ...
  legend(x = "topright", bty = "n", legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), lty = rep("solid", 3), col = c("black", "red", "blue"))
  plot(timesct, days$Global_reactive_power, col = "black", type = "l", main = "", xlab = "datetime", ylab = "Global_reactive_power")
  dev.off()
}